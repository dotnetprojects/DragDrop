 ...
 * 
 * Base class for droptargets. Any instance of this control will allow dragsources (assuming
 * they have the right to be dropped on the specific instance) to be dropped onto it.
 * 
...
namespace SL_Drag_Drop_BaseClasses
{
    ...
    public class DropTarget : Control, IDisposable
    {
        ...
        /// </summary>
        public UserControl Ghost
        {
            get { return (UserControl)GetValue(GhostProperty); }
        ...
        public static readonly DependencyProperty GhostProperty =
            DependencyProperty.Register("Ghost", typeof(UserControl), typeof(DropTarget),
