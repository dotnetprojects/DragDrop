/* Kevin Dockx, 02/2009, updated 04/2009
 * 
 ...
 * 
 * Part of this code has been inspired by Martin Grayson's Blacklight component suite.  
 * Get it at http://www.codeplex.com/blacklight/
 * 
...
namespace SL_Drag_Drop_BaseClasses
{
    ...
    public class DragSource : ContentControl, IDisposable
    {
        ...
        public object Ghost
        {
            get { return (object)GetValue(GhostProperty); }
        ...
        public static readonly DependencyProperty GhostProperty =
            DependencyProperty.Register("Ghost", typeof(object), typeof(DragSource),
        ...
        private Grid MainDraggableControl;
        ...
        /// </summary>
        /// <param name="from"></param>
        internal Storyboard ReturnAnimateOnSwitch(Point from)
        {
            // start animation
            Storyboard sb = Animation.ReturnDragToOriginalPosition(MainDraggableControl, from, new Point(0, 0));
            return sb;
        ...
        internal void ReturnToOriginalPosition()
        {
            ...
            {
                Storyboard sb = Animation.ReturnDragToOriginalPosition(MainDraggableControl, currentCanvasPosition, new Point(0, 0));
